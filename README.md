...
- **Refresh Tokens**: Long-lived (7 days) stored in Redis with TTL
- **Token Blacklisting**: Invalidated tokens are blacklisted in Redis on logout
...
| ACCESS_TOKEN_SECRET | Yes | - | Secret for access tokens |
